                    ...
                    <div class='items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16'>
                        <div class='text-gray-500 sm:text-lg dark:text-gray-400'>
                            ...
                            <p class='mb-8 font-light lg:text-xl'>
                                Deliver great service experiences fast - without the complexity of traditional ITSM solutions. Accelerate critical development work, eliminate toil, and deploy changes
                                with ease.
                            </p>
